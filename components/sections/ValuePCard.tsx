...
const ValuePCard = ({ value }: { value: Value }) => {
  return (
    <div
      key={value.id}
      className="group bg-white rounded-3xl p-8 text-center shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all duration-300 hover:-translate-y-2 border border-gray-100 flex flex-col items-center"
    >
